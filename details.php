...
<nav>
		...
		<a href="function/product.php">Product</a>
...
<div id="container">
	<!-- <div class="nav">
			 <ul>
				...
				<li><a href="function/aboutus.php">   <i class="icon-bookmark"></i>About Us</a></li>
				<li><a href="function/contactus.php""><i class="icon-inbox"></i>Contact Us</a></li>
				<li><a href="#"><i class="icon-info-sign"></i>Privacy Policy</a></li>
				<li><a href="#"><i class="icon-question-sign"></i>FAQs</a></li>
			</ul>
	</div> -->
		<?php
			if(isset($_GET['id'])){
			$id = $_GET['id'];
			$query = $con->query("SELECT * FROM product WHERE product_id = '$id' ");
			$row = $query->fetch_array();
		?>
		<div>
			<center>
				<img class="img-polaroid" style="width:300px; height:300px;" src="photo/<?php echo $row['product_image']; ?>">
				<h2 class="text-uppercase bg-primary"><?php echo $row['product_name']?></h2>
				<p class="text-uppercase" style="font-size: 20px;">Price <?php echo $row['product_price']?></p>
				<p class='text-info' style="font-size: 20px;">Size: <?php echo $row['product_size']?></p>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<h4>Total: Price <?php echo $row['product_price']; ?> </h4>
						<br />
