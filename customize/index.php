		    ...
		    <div class="span3">
		    	...
		    	<div class="tabbable"> <!-- Only required for left/right tabs -->
				  <ul class="nav nav-tabs">
				    ...
				    <li><a href="#tab2" class="tab-pane active" data-toggle="tab">Sticker</a></li>
				  </ul>
...
<!--						      <p>-->
						      	<select id="tshirttype">
									<label>Color</label>                  
				                    <option value="img/shoes.jpeg" selected="selected">White</option>
				                    <option value="" >Black</option>                                        
								</select>								
					      </div>
				     </div>				   
				    <div class="tab-pane" class="tab-pane active" id="tab2">
				    	<div class="well">
		    ...
		    <div class="span6">		    
                ...
                <!-- <button id="flipback" type="button" class="btn" title="Rotate View"><i class="icon-retweet" style="height:19px;"></i></button> -->
					<div id="shirtDiv" class="page" style="width: 530px; height: 630px; position: relative; background-color: rgb(255, 255, 255);">
						<img name="tshirtview" id="tshirtFacing" src="img/shoes.jpeg">
						<div id="drawingArea" style="position: absolute;top: 100px;left: 160px;z-index: 10;width: 200px;height: 400px;">					
							<canvas id="tcanvas" width=300 height="450" class="hover" style="-webkit-user-select: none;"></canvas>
						</div>
					</div>
