	...
	<div id="header">
		...
		<label>Shoe Store</label>
			...
			<?php
				...
				$fetch = $con->fetch_array($query);
			?>

			<ul>
				<li><a href="function/logout.php"><i class="icon-off icon-black"></i>logout</a></li>
				<li><a href="#profile" href  data-toggle="modal">Welcome:&nbsp;&nbsp;&nbsp;<i class="icon-user icon-black"></i><?php echo $fetch['firstname']; ?>&nbsp;<?php echo $fetch['lastname'];?></a></li>
			</ul>
	</div>
<div id="container">
			<?php
			...
			$query = $con->query ("SELECT * FROM customer WHERE customerid = '$id' ") or die (mysql_error());
					...
					<form method="POST" action="function/edit_customer.php">
						...
						<h3>Edit My Account...</h3>
							<table>
								...
								<tr>
									<td>Middelname :</td><td><input type="text" name="mi" placeholder="Middle Initial" maxlength="1" required value="<?php echo $mi;?>"></td>
								</tr>
								<tr>
								...
								<tr>
									<td>Country:</td><td><input type="text" name="country" placeholder="Province" required value="<?php echo $country;?>"></td>
								</tr>
								<tr>
